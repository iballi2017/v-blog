  ...
  <div id="addBlog">
    <div class="form-container">
      ...
      <form action="" v-if="!formSubmitted">
        ...
        <div class="form-grp">
          <button class="form-btn" type="submit" v-on:click.prevent="postData">
            POST
          </button>
      ...
      <div id="preview">
        ...
        <p>Categories:</p>
        <ul>
          <li v-for="(category, cat) in blog.categories" :key="cat">
            {{ category }}
          </li>
        </ul>
        <p>Author: {{ blog.author }}</p>
      </div>
      <router-link to="/blog" exact class="blogs-link doc-link"
